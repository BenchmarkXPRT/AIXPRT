...
static const char model_name_message[] = "MLxBench. Path to an .xml file with a trained model.";
DEFINE_string(b, "", "Batch size");
static const char batch_size_message[] = "MLxBench. image batch size (default 1)";
DEFINE_string(aarch, "", "Architecture");
static const char architecture_message[] = "MLxBench. Specify the target device to infer on; CPU, GPU, FPGA, HDDL or MYRIAD is acceptable. ";
