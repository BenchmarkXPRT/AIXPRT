...
inferenceFilePath = os.path.join(os.environ['APP_HOME'],"Modules","Deep-Learning","workloads","commonsources","bin","image_classification","classify_imagenet_resnet50.py")
...
for j in batch_size_number:
    ...
    for ins in range(concurrent_instances):
        ...
        workload_dir,'result','output','resnet50_batch_'+str(j)+'_'+precision+'_concurrent_instance'+str(ins)+'.csv')
